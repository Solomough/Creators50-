      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-8 md:p-12 mb-12">
          <p className="text-lg md:text-xl text-foreground/90 leading-relaxed mb-6">
            <span className="text-primary font-semibold">Creators50</span> is a 50-day transformation track designed for young minds (ages 15–25) who are ready to live with purpose, grow in excellence, and stand out in today's distracted world.
          </p>
          <p className="text-lg md:text-xl text-foreground/90 leading-relaxed mb-6">
          ...
          <div className="bg-primary/10 border-l-4 border-primary px-6 py-4 rounded-r-lg">
            <p className="text-lg md:text-xl font-medium text-foreground italic">
              This is not just a training — it's a movement of builders, innovators, and ambassadors of light.
            </p>
          </div>
        </div>
